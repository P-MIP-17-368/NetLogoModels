  ...
  if (p-event > 0 and p-event <= 1) and random-float 1 < p-event  and prob-creator-gene > 0 [
    ...
    [
      ...
      [
        ...
        ifelse event-cultural-distance
...
@#$#@#$#@
<experiments>
  <experiment name="experiment-similar-over-neighbourhood" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="event-distance-impact">
      <value value="&quot;Distance exponential&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="save-world-png">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="negative-impact-prob">
      <value value="0"/>
  ...
  <experiment name="experiment-event-impact-radius" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3000"/>
    <metric>count turtles</metric>
  ...
  <experiment name="experiment-interaction-history-discount" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3000"/>
    <metric>count turtles</metric>
  ...
  <experiment name="experiment-c-uniqueness" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3000"/>
    <metric>count turtles</metric>
  ...
  <experiment name="prob-event" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3000"/>
    <metric>count turtles</metric>
  ...
  <experiment name="neighbours-to-choose-from" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3000"/>
    <metric>count turtles</metric>
  ...
  <experiment name="experiment-num-features-axelrodlike" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3000"/>
    <metric>count turtles</metric>
    ...
    <enumeratedValueSet variable="similar-over-neighborhood">
      <value value="0"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="cultural-distance">
      <value value="false"/>
    ...
    <enumeratedValueSet variable="interaction-neighbors-per-tick">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="prob-creator-gene">
      <value value="0.23"/>
  ...
  <experiment name="soc-capital-init-and_weight" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3000"/>
    <metric>count turtles</metric>
  ...
  <experiment name="experiment-soccap-uniquenss-2" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="experiment-neighborhood-wo-broadcast" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="experiment-uniq-wo_broadcast" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="10000"/>
    <metric>count turtles</metric>
  ...
  <experiment name="experiment-event" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="3000"/>
    <metric>count turtles</metric>
