...
to neighbours-interaction
  ...
  [
    ...
    ;set color blue
    set turtle-A self
    ; selecting one of 2 closest turtles to him without himself
    ask one-of min-n-of 2 other turtles [distance turtle-A]
    [
...
to-report check-end?
  ...
  ifelse num-cluster = 1
   ...
   [ ask turtles [
      ...
      set turtle-A self
      set culture-A culture
      ask min-n-of 2 other turtles [distance turtle-A] [set ll true]
      let stopped false
      ...
      ask min-n-of 2 other turtles [distance turtle-A] [set ll false]
      if stopped [stop]
    ]
   ]
  report end?
